      ...
      <div className="space-y-4 p-4">
        <div className="space-y-2">
          ...
          <ToggleGroup
            ...
            onValueChange={(v: string) =>
              v && setViewMode(v as "points" | "heatmap")
            }
            className="w-full"
          >
            <ToggleGroupItem
        ...
        <div className="space-y-2">
          ...
          <ToggleGroup
            ...
            value={basemap}
            onValueChange={(v: string) =>
              v && setBasemap(v as "dark" | "satellite" | "terrain")
            }
            className="w-full"
          >
            <ToggleGroupItem
            ...
            {activeCategories.map((cat) => {
              ...
              return (
                <Toggle
                  ...
                  size="sm"
                  className={`h-7 px-2.5 gap-1.5 text-xs ${categoryFilter && !isActive ? "opacity-40" : ""}`}
                >
                  <span
